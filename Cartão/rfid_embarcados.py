...
"""
    ...
    sera lanada a exceo na sequencia
"""
try:
    import MFRC522
...
def check_user():
    if os.geteuid() != 0:
        print("Vc  deve executar o programa como super-usuario!")
...
"""
    Captura o sinal gerado, no caso o que nos interessa eh o sinal
    SIGINT(Interrupo do Terminal ou processo) e ir encerrar a aplicao
"""
def finalizar_app(signal,frame):
    global continue_reading
    print("\nCtrl+C pressionado, encerrando aplica...")
...
def main():
    ...
    print("Portal Embarcados - Python eh sucesso!")
